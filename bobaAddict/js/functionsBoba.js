...
//Gets the previous boba shop, after the prev button clicked
function prevBoba() {
...
//Gets the next boba shop, after the next button clicked
function nextBoba() {
...
//Parses through data and updates page with boba information
function parse(data, index) {
    ...
    for (var i = 0; i < busCount; i++) {
        ...
        bobaLat.push(data.businesses[i].coordinates.latitude);
        bobaLng.push(data.businesses[i].coordinates.longitude);
    }
    ...
    //If no boba shops found
    if (name[index] == undefined) {
        document.getElementById("bobaTitle").innerHTML = "<strong>" + "No Boba Shops found :((" + "</strong>";
        document.getElementById("address").innerHTML = "Try changing your search preferences!";
        document.getElementById("navButtons").innerHTML = "";
        document.getElementById("bobaImage").src = "images/favicon.png";
    ...
    document.getElementById("bobaTitle").innerHTML = "<strong><a href=" + url[index] + " target='_blank'>" + name[index] + "</a></strong>";
    document.getElementById("navButtons").innerHTML = (index + 1) + " out of " + busCount + " found";
    document.getElementById("bobaImage").src = imgUrl[index];
    ...
    myMap(bobaLat[index], bobaLng[index], userLat, userLng);
}
